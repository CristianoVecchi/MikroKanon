...
data class Lang( // English by default
    ...
    val selectDrumsResize: String = "Select the resize of the rhythm pattern!",
    val checkAndReplace: String= "Check and replace",
    //val selectPitchRange: String= "Select the range!",
...
//        "BPM *2 BPM", "BPM /2 BPM", "BPM *2 BPM /2", "BPM /2 BPM *2"),
    ...
    val selectMbti: String = "Select the MBTI to change intervals!",
    ...
    val selectFormatForm: String = "Select a format form!",
    ...
    val selectChessRange: String = "Select a range for the chessboard!",
    ...
    companion object {
        ...
        fun thai(): Lang {
            return Lang(
                noteNames = NoteNamesTh.values().map { it.toString() },
                intervalSet = intervalSetTh,
                ensemble = "วงดนตรี",
                enterSomeNotes = "พิมพ์โน้ตดนตรี!",
                choose2ndSequence = "เลือกลำดับที่ 2!",
                chooseAnotherSequence = "เลือกลำดับอื่น!",
                selectQuoteGenres= "เลือกประเภทสำหรับการอ้างอิง!",
                repeatSequence = "ทำซ้ำลำดับ!",
                selectEnsemble = "เลือกวงดนตรี",
                ensembleNames = ensembleNamesTh,
                range = "ส่วนขยาย",
                selectRange = "เลือกส่วนขยาย!",
                rangeOptions = listOf("ฟรี", "ของเครื่องดนตรี", "จำกัดขอบเขต", "เกือบปิด", "ปิด"),
                articulation = "ข้อต่อ",
                selectArticulation = "เลือกวิธีการเปลี่ยนแปลงการออกเสียง!",
                selectMelody ="เลือกประเภททำนอง!",
                melody = "เมโลดี้",
                //melodyOptions = listOf("Lineare","Ampia"),
                selectGlissando = "เลือกช่วงเสียงดนตรีสำหรับกลิสซานโด!",
                selectVibrato = "เลือกความเข้มข้นของเสียงสั่นได้!",
                nuancesOptions = listOf("ไม่มีเลย", "โน้ตสั้นโดดเด่น", "โน้ตยาวโดดเด่น"),
                nuances = "ความแตกต่าง",
                selectNuances = "เลือกเฉดสีที่ให้ความรู้สึกไดนามิก!",
                harmony = "ความสามัคคี",
                selectHarmonizationType = "เลือกรูปแบบการประสานงาน!",
                selectHarmonizationDivision = "เลือกส่วนของบาร์ดนตรี!",
                selectHarmonizationInstruments = "เลือกเครื่องดนตรีแห่งการประสานเสียง!",
                selectHarmonizationVolume = "เลือกระดับเสียงของการประสานเสียง!",
                selectOctaves = "เลือกอ็อกเทฟ!",
                selectHarmonizationStyle = "เลือกสไตล์การประสานความกลมกลืน!",
                selectStyleDensity = "เลือกความหนาแน่นของสไตล์ได้!",
                drums = "เครื่องเพอร์คัชชัน",
                selectDrumsType = "เลือกสไตล์การเพอร์คัชชันของคุณ!",
                selectDrumKit = "เลือกประเภทของเครื่องเพอร์คัชชัน!",
                selectDrumsVolume = "เลือกระดับความดังของเสียงเพอร์คัชชันได้!",
                selectDrumsDensity = "เลือกความหนาแน่นของการกระทบได้!",
                selectDrumsResize = "เลือกการปรับสเกลรูปแบบจังหวะ!",
                checkAndReplace = "ค้นหาและแทนที่",
                //selectPitchRange = "Scegli un'estensione!",
                selectCheckType  = "เลือกประเภทการตรวจจับ!",
                selectReplaceType  = "เลือกประเภทการเปลี่ยน!",
                selectStress  = "เลือกความเครียดของการทดแทน!",
                chordsToEnhance= "คอร์ดเพลงเพื่อเสริมพลัง",
                selectChordsToEnhance= "เลือกคอร์ดเพลงที่คุณต้องการปรับปรุง!",
                enhanceChordsInTranspositions= "การรักษาคอร์ดดนตรีให้โดดเด่นในการเปลี่ยนเสียง",
                dynamics = "พลวัต",
                selectDynamicAlterations ="เลือกวิธีการเปลี่ยนแปลงไดนามิก!",
                beatsPerMinute = "เต้นต่อนาที",
                selectRhythm = "เลือกก้าว!",
                selectDoubling = "เลือกช่วงดนตรีสำหรับการเพิ่มเป็นสองเท่า!",
                doublingNames = doublingTh,
                selectAudio8D = "เลือกเสียงใน AUDIO 8D!",
                rhythm = "จังหวะ",
                shuffle = "สับเปลี่ยน",
                selectShuffle = "เลือกสับเปลี่ยน!",
                rhythmShuffle  = "ผสมจังหวะ",
                partsShuffle  = "ผสมเสียง",
                rowForms = "แบบฟอร์มอนุกรม",
                selectRowForms = "เลือกแบบรูปทรงซีเรียล!",
                original = "ต้นฉบับ",
                retrograde  = "ถอยหลังเข้าคลอง",
                inverse  = "ย้อนกลับ",
                invRetrograde  = "การย้อนกลับของการถอยหลังเข้าคลอง",
                selectRitornello = "เลือกได้ว่าจะทำซ้ำกี่ครั้ง!",
                transpose = "ย้าย",
                selectTranspositions = "เลือกการเปลี่ยนแปลง!",
                doubling  = "สองเท่า",
                spreadWherePossible  = "ขยายออกไปเท่าที่เป็นไปได้",
                deepSearch  = "การวิจัยเชิงลึกในแคนนอนสี่เสียง",
                horIntervalSet = "ช่วงเวลาเสียงฟรี",
                detector = "เครื่องตรวจจับ",
                selectIntervalsToDetect = "เลือกช่วงเสียงดนตรีที่จะตรวจจับ!",
                detectorExtension = "ส่วนขยายของเครื่องตรวจจับ",
                selectDetectorExtension = "เลือกส่วนขยายเครื่องตรวจจับ!",
                exportMidi  = "ส่งออกไฟล์ MIDI",
                customColors = "สี",
                counterpointView = "ดู",
                selectCounterpointView = "เลือกมุมมองแบบตรงกันข้าม!",
                counterpointViewOptions = listOf("โน้ต", "หินอ่อน", "ควอนตัม"),
                language  = "ภาษา",
                zodiac = "ราศี",
                zodiacOptions = listOf("ดาวเคราะห์", "ราศี", "อีโมจิ"),
                selectZodiac = "ใช้สัญลักษณ์จักรราศีเหล่านี้:" ,
                selectMbti= "เลือก MBTI เพื่อเปลี่ยนช่วงดนตรี!",
                selectSpecialFunction = "เลือกฟังก์ชั่น!",
                selectCadenzaForm = "เลือกแบบจังหวะ!",
                selectResolutioForm = "เลือกแบบความละเอียด!",
                selectFormatForm = "เลือกรูปแบบรูปร่าง!",
                selectToOverlap = "เลือกจุดตรงข้ามที่จะทับซ้อนกัน!",
                selectToCrossOver = "เลือกจุดตรงข้ามที่จะข้ามไป!",
                selectToGlue = "เลือกจุดตรงข้ามเพื่อติดกาว!",
                selectChessRange = "เลือกช่วงสำหรับบอร์ด!",
                addSequencesToMaze = "เพิ่มลำดับเพิ่มเติมให้กับเขาวงกต!",
                selectHorizontalIntervals = "เลือกช่วงเมโลดี้สำหรับฟังก์ชั่น!",
                clearSlots = "ล้างช่องว่าง",
                selectSlots = "เลือกช่องว่างที่จะว่าง!",
            )
        }
        fun english(): Lang {
            return Lang()
        ...
        fun french(): Lang {
            return Lang(
                ...
                selectQuoteGenres= "Sélectionnez les genres pour la citation !",
                ...
                selectHarmonizationStyle = "Sélectionnez le style d'harmonisation !",
                selectStyleDensity = "Sélectionnez la densité de style !",
                drums = "Batterie ",
                selectDrumsType = "Sélectionnez le style de la batterie !",
                selectDrumKit = "Sélectionnez le type de la batterie !",
                selectDrumsVolume = "Sélectionnez le volume de la batterie !",
                selectDrumsDensity = "Sélectionnez la densité de la batterie !",
                selectDrumsResize = "Sélectionnez le redimensionnement du pattern rythmique !",
                checkAndReplace = "Détecter et remplacer",
                //selectPitchRange = "Sélectionnez la gamme !",
                ...
                shuffle = "Shuffle ",
                selectShuffle = "Sélectionnez le shuffle !",
                ...
                selectMbti= "Sélectionnez le MBTI pour changer les intervalles !",
                selectSpecialFunction = "Choisissez une fonction !",
                selectCadenzaForm = "Choisissez une forme de cadence !",
                selectResolutioForm = "Choisissez une forme de résolution !",
                selectFormatForm = "Choisissez une forme de format !",
                ...
                selectChessRange = "Sélectionnez une plage pour l'échiquier !",
        ...
        fun spanish(): Lang {
            return Lang(
               ...
               // melodyOptions = listOf("Lineal","Amplia"),
                ...
                selectHarmonizationStyle = "¡Seleccione el estilo de armonización!",
                selectStyleDensity = "¡Seleccione la densidad del estilo!",
                drums = "Batería",
                selectDrumsType = "¡Elige el estilo de la batería!",
                selectDrumKit = "¡Elige el tipo de batería!",
                selectDrumsVolume = "¡Elige el volumen de la batería!",
                selectDrumsDensity = "¡Elige la densidad de la batería!",
                selectDrumsResize = "¡Seleccione el cambio de tamaño del patrón rítmico!",
                ...
                rhythm = "Ritmo",
                shuffle = "Shuffle",
                selectShuffle = "¡Selecciona el shuffle!",
                ...
                selectMbti= "¡Seleccione el MBTI para cambiar los intervalos!",
                selectSpecialFunction = "¡Elija una función!",
                selectCadenzaForm = "¡Elija una forma de cadencia!",
                selectResolutioForm = "¡Elija una forma de resolución!",
                selectFormatForm = "¡Elige una forma de formato!",
                ...
                selectChessRange = "¡Selecciona un rango para el tablero de ajedrez!",
        ...
        fun german(): Lang {
            return Lang(
                ...
                selectHarmonizationStyle = "Wählen Sie den Harmonisierungsstil!",
                selectStyleDensity = "Wählen Sie die Stildichte!",
                drums = "Schlagzeug",
                selectDrumsType = "Wählen Sie den Stil des Schlagzeugs!",
                selectDrumKit = "Wählen Sie den Typ des Schlagzeugs!",
                selectDrumsVolume = "Wählen Sie die Lautstärke des Schlagzeugs!",
                selectDrumsDensity = "Wählen Sie die Dichte des Schlagzeugs!",
                selectDrumsResize = "Wählen Sie die Größenänderung des Rhythmusmusters!",
                ...
                rhythm = "Rhythmus",
                shuffle = "Swing",
                selectShuffle = "Wählen Sie den Swing!",
                ...
                selectMbti= "Wählen Sie den MBTI, um die Intervalle zu ändern!",
                selectSpecialFunction = "Wählen Sie eine Funktion!",
                selectCadenzaForm = "Wähle eine Kadenzform!",
                selectResolutioForm = "Wählen Sie eine Auflösungsform!",
                selectFormatForm = "Wählen Sie eine Formatform!",
                ...
                selectChessRange = "Wählen Sie einen Bereich für das Schachbrett!",
        ...
        fun ukranian(): Lang {
            return Lang(
                ...
                selectQuoteGenres= "Виберіть жанри для цитати!",
                ...
                selectHarmonizationStyle = "Виберіть стиль гармонізації!",
                selectStyleDensity = "Виберіть щільність стилю!",
                drums = "Барабани",
                selectDrumsType = "Виберіть стиль барабанів!",
                selectDrumKit = "Виберіть тип ударної установки!",
                selectDrumsVolume = "Обирайте гучність барабанів!",
                selectDrumsDensity = "Обирайте щільність барабанів!",
                selectDrumsResize = "Виберіть зміну розміру ритмічного малюнка!",
                ...
                selectMbti= "Виберіть MBTI, щоб змінити інтервали!",
                selectSpecialFunction = "Виберіть функцію!",
                selectCadenzaForm = "Виберіть форму каденції!",
                selectResolutioForm = "Виберіть форму вирішення!",
                selectFormatForm = "Виберіть форму формату!",
                ...
                selectChessRange = "Виберіть діапазон для шахівниці!",
        ...
        fun russian(): Lang {
            return Lang(
                ...
                selectQuoteGenres= "Выберите жанры для цитаты!",
               ...
               // melodyOptions = listOf("Линейная","Широкая"),
                ...
                selectHarmonizationStyle = "Выберите стиль гармонизации!",
                selectStyleDensity = "Выберите плотность стиля!",
                drums = "Барабан",
                selectDrumsType = "Выберите стиль барабанов!",
                selectDrumKit = "Выберите тип ударной барабанов!",
                selectDrumsVolume = "Выберите громкость барабанов!",
                selectDrumsDensity = "Выбирайте плотность барабанов!",
                selectDrumsResize = "Выберите изменение размера ритм-паттерна!",
                ...
                selectMbti= "Выберите MBTI, чтобы изменить интервалы!",
                selectSpecialFunction = "Выберите функцию!",
                selectCadenzaForm = "Выберите форму каденции!",
                selectResolutioForm = "Выберите форму разрешения!",
                selectFormatForm = "Выберите форму формата!",
                ...
                selectChessRange = "Выберите диапазон для шахматной доски!",
        ...
        fun korean(): Lang {
            return Lang(
                ...
                selectQuoteGenres= "인용할 장르를 선택하세요!",
               ...
               // melodyOptions = listOf("선형","넓은"),
                ...
                selectHarmonizationStyle = "조화 스타일을 선택하십시오!",
                selectStyleDensity = "스타일 밀도를 선택하세요!",
                drums = "드럼",
                selectDrumsType = "드럼 스타일을 선택하십시오!",
                selectDrumKit = "드럼 키트의 유형을 선택하십시오!",
                selectDrumsVolume = "드럼의 볼륨을 선택하십시오!",
                selectDrumsDensity = "드럼의 밀도를 선택하십시오!",
                selectDrumsResize = "리듬 패턴의 크기 조정을 선택하십시오!",
        ...
        fun   japanese(): Lang {
            return Lang(
                ...
                selectQuoteGenres = "見積もりの\u200B\u200Bジャンルを選択してください!",
                ...
                selectHarmonizationStyle = "ハモナイズスタイルを選択してください！",
                selectStyleDensity = "スタイルの密度を選択してください!",
                drums = "ドラム",
                selectDrumsType = "ドラムのスタイルを選択してください！",
                selectDrumKit = "ドラムキットの種類を選ぼう！",
                selectDrumsVolume = "ドラムの音量を選択してください！",
                selectDrumsDensity = "ドラムの音量を選択してください！",
                selectDrumsResize = "リズムパターンのリサイズを選択！",
        ...
        fun chinese(): Lang {
            return Lang(
               ...
               // melodyOptions = listOf("线性旋律","宽广的旋律"),
                ...
                selectOctaves = "选择八度！",
                selectHarmonizationStyle = "选择和谐风格！",
                selectStyleDensity = "选择款式密度！",
                drums = "鼓",
                selectDrumsType = "选择鼓的风格！",
                selectDrumKit = "选择架子鼓的类型！",
                selectDrumsVolume = "选择鼓的音量！",
                selectDrumsDensity = "选择鼓的密度！",
                selectDrumsResize = "选择节奏模式的调整大小！",
        ...
        fun arabian(): Lang {
            return Lang(
                ...
                selectQuoteGenres = "حدد الأنواع للاقتباس!",
               ...
               // melodyOptions = listOf("لحن خطي","لحن واسع"),
                ...
                selectHarmonizationStyle = "حدد أسلوب التنسيق!",
                selectStyleDensity = "حدد كثافة النمط!",
                drums = "طبول",
                selectDrumsType = "اختر نمط الطبول!",
                selectDrumKit = "اختر نوع طقم الطبل!",
                selectDrumsVolume = "اختر حجم الطبول!",
                selectDrumsDensity = "اختر كثافة البراميل!",
                selectDrumsResize = "حدد تغيير حجم نمط الإيقاع!",
                ...
                rhythm = "إيقاع",
                shuffle = "موسيقى سوينغ",
                selectShuffle = "حدد تأرجح الموسيقى!",
        ...
        fun greek(): Lang {
            return Lang(
                ...
                selectQuoteGenres = "Επιλέξτε είδη για την προσφορά!",
                ...
                selectHarmonizationStyle = "Επιλέξτε το στυλ εναρμόνισης!",
                selectStyleDensity = "Επιλέξτε την πυκνότητα στυλ!",
                drums = "Τύμπανα",
                selectDrumsType = "Επιλέξτε το στυλ των τυμπάνων!",
                selectDrumKit = "Επιλέξτε τον τύπο των τυμπάνων!",
                selectDrumsVolume = "Επιλέξτε την ένταση των τυμπάνων!",
                selectDrumsDensity = "Επιλέξτε την πυκνότητα των τυμπάνων!",
                selectDrumsResize = "Επιλέξτε την αλλαγή μεγέθους του μοτίβου ρυθμού!",
                ...
                rhythm = "Ρυθμός",
                shuffle = "Swing",
                selectShuffle = "Επιλέξτε την Swing!",
                ...
                selectMbti= "Επιλέξτε το MBTI για να αλλάξετε διαστήματα!",
                selectSpecialFunction = "Επιλέξτε μια συνάρτηση!",
                selectCadenzaForm = "Επιλέξτε μια φόρμα ρυθμού!",
                selectResolutioForm = "Επιλέξτε μια φόρμα ανάλυσης!",
                selectFormatForm = "Επιλέξτε ένα σχήμα μορφής!",
                ...
                selectChessRange = "Επιλέξτε ένα εύρος για τη σκακιέρα!",
        ...
        fun kiswahili(): Lang {
            return Lang(
                ...
                selectQuoteGenres = "Chagua aina za nukuu!",
               ...
               // melodyOptions = listOf("Ya laini","Pana"),
                ...
                selectHarmonizationStyle = "Chagua mtindo wa kuoanisha!",
                selectStyleDensity = "Chagua msongamano wa mtindo!",
                drums = "Ngoma",
                selectDrumsType = "Chagua mtindo wa ngoma!",
                selectDrumKit = "Chagua aina ya vifaa vya ngoma!",
                selectDrumsVolume = "Chagua kiasi ya ngoma!",
                selectDrumsDensity = "Chagua wiani wa ngoma!",
                selectDrumsResize = "Chagua kubadilisha ukubwa wa muundo wa mdundo!",
                ...
                selectMbti= "Chagua MBTI ili kubadilisha vipindi!",
                selectSpecialFunction = "Chagua chaguo la kukokotoa!",
                selectCadenzaForm = "Chagua fomu ya mwanguko!",
                selectResolutioForm = "Chagua fomu ya azimio!",
                selectFormatForm = "Chagua umbo la umbizo!",
                ...
                selectChessRange = "Chagua anuwai kwa ubao wa chess!",
        ...
        fun portugues(): Lang {
            return Lang(
               ...
               // melodyOptions = listOf("Linear","Ampla"),
                ...
                selectHarmonizationStyle = "Selecione o estilo de harmonização!",
                selectStyleDensity = "Selecione a densidade do estilo!",
                drums = "Bateria",
                selectDrumsType = "Escolha o estilo da bateria!",
                selectDrumKit = "Escolha o tipo da bateria!",
                selectDrumsVolume = "Escolha o volume da bateria!",
                selectDrumsDensity = "Escolha a densidade da bateria!",
                selectDrumsResize = "Selecione o redimensionamento do padrão de ritmo!",
                ...
                rhythm = "Ritmo",
                shuffle = "Swing",
                selectShuffle = "Selecione o swing!",
                ...
                selectMbti= "Selecione o MBTI para alterar os intervalos!",
                selectSpecialFunction = "Escolha uma função!",
                selectCadenzaForm = "Escolha uma forma de cadência!",
                selectResolutioForm = "Escolha uma forma de resolução!",
                selectFormatForm = "Escolha uma forma de formato!",
                ...
                selectChessRange = "Selecione um intervalo para o tabuleiro de xadrez!",
        ...
        fun bahasa(): Lang {
            return Lang(
                ...
                selectQuoteGenres = "Pilih genre untuk kutipan!",
                ...
                selectHarmonizationStyle = "Pilih gaya harmonisasi!",
                selectStyleDensity = "Pilih kerapatan gaya!",
                drums = "Drum",
                selectDrumsType = "Pilih gaya drum!",
                selectDrumKit = "Pilih jenis drum kit!",
                selectDrumsVolume = "Pilih volume drum!",
                selectDrumsDensity = "Pilih kepadatan drum!",
                selectDrumsResize = "Pilih ukuran pola ritme!",
                ...
                selectMbti= "Pilih MBTI untuk mengubah interval!",
                selectSpecialFunction = "Pilih fungsi!",
                selectCadenzaForm = "Pilih bentuk irama!",
                selectResolutioForm = "Pilih bentuk resolusi!",
                selectFormatForm = "Pilih bentuk format!",
                ...
                selectChessRange = "Pilih rentang untuk papan catur!",
        ...
        fun hindi(): Lang {
            return Lang(
                ...
                selectQuoteGenres = "बोली के लिए शैलियों का चयन करें!",
                repeatSequence = "क्रम दोहराएं",
                OkButton = "ठीक",
                ensemble = "संगीत वाद्ययंत्र",
                ...
                selectHarmonizationStyle = "सामंजस्य शैली का चयन करें!",
                selectStyleDensity = "शैली घनत्व का चयन करें!",
                drums = "ड्रम",
                selectDrumsType = "ड्रम की शैली चुनें!",
                selectDrumKit = "ड्रम किट का प्रकार चुनें!",
                selectDrumsVolume = "ड्रम की मात्रा चुनें!!",
                selectDrumsDensity = "ड्रम की मात्रा चुनें!",
                checkAndReplace = "पता लगाएं और बदलें",
                selectDrumsResize = "ताल पैटर्न के आकार का चयन करें!",
                ...
                rhythm = "ताल",
                shuffle = "झूला संगीत",
                selectShuffle = "संगीत के झूले का चयन करें!",
                ...
                selectMbti= "अंतराल बदलने के लिए एमबीटीआई का चयन करें!",
                selectSpecialFunction = "एक फ़ंक्शन चुनें!",
                selectCadenzaForm = "एक ताल प्रपत्र चुनें!",
                selectResolutioForm = "एक संकल्प प्रपत्र चुनें!",
                selectFormatForm = "एक प्रारूप आकार चुनें!",
                ...
                selectChessRange = "बिसात के लिए एक श्रेणी चुनें!",
        ...
        fun icelandic(): Lang {
            return Lang(
                noteNames = NoteNamesEn.values().map { it.toString() },
                intervalSet = intervalSetIs,
                ensemble = "Hljómsveit",
                enterSomeNotes = "Sláðu inn nokkrar tónlistarnótur!",
                choose2ndSequence = "Veldu aðra röð!",
                chooseAnotherSequence = "Veldu aðra röð!",
                selectQuoteGenres= "Veldu tegundir fyrir tilvitnun!",
                repeatSequence = "Endurtaktu röðina",
                selectEnsemble = "Veldu hljómsveit!",
                ensembleNames = ensembleNamesIs,
                range = "Framlenging",
                selectRange = "Veldu framlengingu!",
                rangeOptions = listOf("Ókeypis", "Hljóðfæri", "Afmörkuð", "Næstum lokað", "Lokað"),
                articulation = "Framsögn",
                selectArticulation = "Veldu hvernig framsetningin breytist!",
                selectMelody ="Veldu lagtegund!",
                melody = "Lag",
                //melodyOptions = listOf("Lineare","Ampia"),
                selectGlissando = "Veldu tónlistartíma fyrir glissando!",
                selectVibrato = "Veldu styrkleika vibratosins!",
                nuancesOptions = listOf("Engin", "Stuttar nótur skera sig úr", "Löngir nótur skera sig úr"),
                nuances = "Blæbrigði",
                selectNuances = "Veldu blæbrigði fyrir gangverkið!",
                harmony = "Samhljómur",
                selectHarmonizationType = "Veldu gerð samræmingar!",
                selectHarmonizationDivision = "Veldu skiptingu tónlistarbarsins!",
                selectHarmonizationInstruments = "Veldu hljóðfæri samhæfingar!",
                selectHarmonizationVolume = "Veldu hljóðstyrk samstillingarhljóðsins!",
                selectOctaves = "Veldu áttundir!",
                selectHarmonizationStyle = "Veldu samræmingarstíl!",
                selectStyleDensity = "Veldu þéttleika stílsins!",
                drums = "Slagverk",
                selectDrumsType = "Veldu slagverksstíl þinn!",
                selectDrumKit = "Veldu tegund slagverks!!",
                selectDrumsVolume = "Veldu hljóðstyrk slagverksins!",
                selectDrumsDensity = "Veldu þéttleika slagverksins!",
                selectDrumsResize = "Veldu hrynjandi mynstur mælikvarða!",
                checkAndReplace = "Finndu og skiptu út",
                //selectPitchRange = "Scegli un'estensione!",
                selectCheckType  = "Veldu tegund uppgötvunar!",
                selectReplaceType  = "Veldu tegund skipta!",
                selectStress  = "Veldu streitu við skipti!",
                chordsToEnhance= "Hljómar til að auðkenna",
                selectChordsToEnhance= "Veldu hljóminn sem þú vilt bæta!",
                enhanceChordsInTranspositions= "Að halda hljómunum upphafnum í umsetningum",
                dynamics = "Dynamic",
                selectDynamicAlterations ="Veldu hvernig gangverkið breytist!",
                beatsPerMinute = "Slög á mínútu",
                selectRhythm = "Veldu hraða!",
                selectDoubling = "Veldu tónlistarbil fyrir tvöföldun!",
                doublingNames = doublingIs,
                selectAudio8D = "Veldu raddir í AUDIO 8D!",
                rhythm = "Rhythm",
                shuffle = "Uppstokkun",
                selectShuffle = "Veldu uppstokkun!",
                rhythmShuffle  = "Blandaðu hraðanum saman",
                partsShuffle  = "Blandaðu raddunum",
                rowForms = "Raðform",
                selectRowForms = "Veldu raðform!",
                original = "Upprunalegt",
                retrograde  = "Retrograde",
                inverse  = "Öfugt",
                invRetrograde  = "Afturfærsla hins öfuga",
                selectRitornello = "Veldu hversu oft á að endurtaka!!",
                transpose = "Lögleiða",
                selectTranspositions = "Veldu lögleiðingar!",
                doubling  = "Tvöfaldur",
                spreadWherePossible  = "Framlengdu þar sem hægt er",
                deepSearch  = "Ítarlegar rannsóknir í fjögurra radda kanónum",
                horIntervalSet = "Ókeypis raddbil",
                detector = "Skynjari",
                selectIntervalsToDetect = "Veldu millibil til að greina!",
                detectorExtension = "Skynjaraframlenging",
                selectDetectorExtension = "Veldu skynjaraframlenginguna!",
                exportMidi  = "Flyttu út MIDI skrána",
                customColors = "Litir",
                counterpointView = "Skoða",
                selectCounterpointView = "Veldu kontrapunktískt útsýni!",
                counterpointViewOptions = listOf("Tónnótur", "Kúlur", "Quantum"),
                language  = "Tungumál",
                zodiac = "Stjörnumerkio",
                zodiacOptions = listOf("Plánetur", "Stjörnumerki", "Emojis"),
                selectZodiac = "Notaðu þessi stjörnumerki:" ,
                selectMbti= "Veldu MBTI til að breyta tónlistarbili!",
                selectSpecialFunction = "Veldu aðgerð!",
                selectCadenzaForm = "Veldu taktform!",
                selectResolutioForm = "Veldu form af upplausn!",
                selectFormatForm = "Veldu sniðform!",
                selectToOverlap = "Veldu kontrapunkt til að skarast!",
                selectToCrossOver = "Veldu kontrapunkt til að fara yfir!",
                selectToGlue = "Veldu kontrapunkt til að líma!",
                selectChessRange = "Veldu svið fyrir borðið!",
                addSequencesToMaze = "Bættu fleiri röð við völundarhúsið!",
                selectHorizontalIntervals = "Veldu melódískt millibil fyrir aðgerðir!",
                clearSlots = "Tæmdu rýmin",
                selectSlots = "Veldu rými til að tæma!",
            )
        }
        fun polish(): Lang {
            return Lang(
                noteNames = NoteNamesEn.values().map { it.toString() },
                intervalSet = intervalSetPl,
                ensemble = "Zespół",
                enterSomeNotes = "Cyfra nut!",
                choose2ndSequence = "Wybierz drugą sekwencję!",
                chooseAnotherSequence = "Wybierz inną sekwencję!",
                selectQuoteGenres= "Wybierz gatunki do cytowania!",
                repeatSequence = "Powtórz sekwencję",
                selectEnsemble = "Wybierz zespół!",
                ensembleNames = ensembleNamesPl,
                range = "Zakres",
                selectRange = "Wybierz zakres!",
                rangeOptions = listOf("Wolny", "Instrument", "Ograniczony", "Prawie zamknięty", "Zamknięty"),
                articulation = "Artykulacja",
                selectArticulation = "Wybierz sposób zmiany artykulacji!",
                selectMelody ="Wybierz rodzaj melodii!",
                melody = "Melodia",
                //melodyOptions = listOf("Lineare","Ampia"),
                selectGlissando = "Wybierz interwały dla glissanda!",
                selectVibrato = "Wybierz intensywność vibrato!",
                nuancesOptions = listOf("Brak", "Krótkie nuty wyróżniają się", "Długie nuty wyróżniają się"),
                nuances = "Niuanse",
                selectNuances = "Wybierz niuanse dla dynamiki!",
                harmony = "Harmonia",
                selectHarmonizationType = "Wybierz rodzaj harmonizacji!",
                selectHarmonizationDivision = "Wybierz dział baru!",
                selectHarmonizationInstruments = "Wybierz instrumenty harmonizujące!",
                selectHarmonizationVolume = "Wybierz głośność harmonizacji!",
                selectOctaves = "Wybierz oktawy!",
                selectHarmonizationStyle = "Wybierz styl harmonizacji!",
                selectStyleDensity = "Wybierz gęstość stylu!",
                drums = "Perkusja",
                selectDrumsType = "Wybierz swój styl gry na perkusji!",
                selectDrumKit = "Wybierz rodzaj perkusji!",
                selectDrumsVolume = "Wybierz głośność perkusji!",
                selectDrumsDensity = "Wybierz gęstość perkusji!",
                selectDrumsResize = "Wybierz skalowanie wzoru rytmicznego!",
                checkAndReplace = "Znajdź i zamień",
                //selectPitchRange = "Scegli un'estensione!",
                selectCheckType  = "Wybierz rodzaj wykrywania!",
                selectReplaceType  = "Wybierz rodzaj wymiany!",
                selectStress  = "Wybierz stres związany z wymianą!",
                chordsToEnhance= "Akordy do wyróżnienia",
                selectChordsToEnhance= "Wybierz akord, który chcesz wzmocnić!",
                enhanceChordsInTranspositions= "Utrzymywanie akordów w transpozycjach",
                dynamics = "Dynamika",
                selectDynamicAlterations ="Wybierz dynamiczne zmiany!",
                beatsPerMinute = "Uderzenia na minutę",
                selectRhythm = "Wybierz rytm!",
                selectDoubling = "Wybierz interwały do \u200B\u200Bpodwojenia!",
                doublingNames = doublingPl,
                selectAudio8D = "Wybierz głosy w AUDIO 8D!",
                rhythm = "Rytm",
                shuffle = "Shuffle",
                selectShuffle = "Wybierz shuffle!",
                rhythmShuffle  = "Zmiksuj rytm!",
                partsShuffle  = "Zmiksuj głosy!",
                rowForms = "Formularze seryjne",
                selectRowForms = "Wybierz formularze seryjne!",
                original = "Oryginalny",
                retrograde  = "Wsteczny",
                inverse  = "Odwracać",
                invRetrograde  = "Odwrotność ruchu wstecznego",
                selectRitornello = "Wybierz, ile razy chcesz powtórzyć!",
                transpose = "Transponować",
                selectTranspositions = "Wybierz transpozycje!",
                doubling  = "Podwójnie",
                spreadWherePossible  = "Rozwiń, jeśli to możliwe",
                deepSearch  = "Głębokie badania kanonów czterogłosowych",
                horIntervalSet = "Bezpłatne interwały głosowe",
                detector = "Detektor",
                selectIntervalsToDetect = "Wybierz interwały do wykrycia!",
                detectorExtension = "Promień detektora",
                selectDetectorExtension = "Wybierz promień detektora!",
                exportMidi  = "Wyeksportuj plik MIDI",
                customColors = "Zabarwienie",
                counterpointView = "Widok",
                selectCounterpointView = "Wybierz widok kontrapunktowy!",
                counterpointViewOptions = listOf("Nuty", "Kulki", "Kwant"),
                language  = "Język",
                zodiac = "Zodiak",
                zodiacOptions = listOf("Planety", "Znaki", "Emoji"),
                selectZodiac = "Użyj tych symboli zodiaku:" ,
                selectMbti= "Wybierz MBTI, aby zmienić interwały muzyczne!",
                selectSpecialFunction = "Wybierz funkcję!",
                selectCadenzaForm = "Wybierz formę kadencji!",
                selectResolutioForm = "Wybierz formę rezolucji!",
                selectFormatForm = "Wybierz format kształtu!",
                selectToOverlap = "Wybierz kontrapunkt do nałożenia!",
                selectToCrossOver = "Wybierz kontrapunkt do przejścia",
                selectToGlue = "Wybierz kontrapunkt do przyklejenia",
                selectChessRange = "Wybierz zakres dla planszy!",
                addSequencesToMaze = "Dodaj więcej sekwencji do labiryntu!",
                selectHorizontalIntervals = "Wybierz interwały melodyczne dla funkcji!",
                clearSlots = "Opróżnij przestrzenie",
                selectSlots = "Wybierz miejsca, które chcesz opróżnić!",
            )
        }
    }
}

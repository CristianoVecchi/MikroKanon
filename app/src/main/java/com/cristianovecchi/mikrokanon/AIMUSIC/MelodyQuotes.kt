...
enum class ChoraleQuotes(val pitches: List<Int>){
    ACH_BLEIB_1(listOf(12,16,14,16,17,19,19,16,16, 21,19,17,16,14,16,16,16,16,16,16)), // Reger
    ACH_BLEIB_2(listOf(19,21,21,23,24,21,21,19,19, 16,14,12,12,11,12,12,12,12,12,12)), // Reger
    ...
    ALLES_IST_1(listOf(7,7,14,14,12,14,11,7,7, 11,11,9,9,7,9,6,2,2, 9,9,11,9,7,6,4,2,2,2,2,2)),
    ALLES_IST_2(listOf(14,14,14,16,12,14,11,7,7, 11,11,9,9,7,9,6,2,2, 7,9,11,12,14,12,11,9,7,7,7,7,7)),
    AUFERSTEHN_1(listOf(13,11,14,13,11,9,8,9,11,11,11,11,11,11, 11,9,8,6,6,4,4,4,4,4,4)), // Reger
    AUFERSTEHN_2(listOf(6,4,6,7,7,6,6,6,6,6,6, 6,8,9,14,13,13,13,11,11,11,11, 13,6,8,9,9,9,9,9,9,9,9,9,9)), // Reger
    AUS_TIEFER_1(listOf(11,11,4,11,12,11,9,7,9,11,11,11,11, 11,11,12,14,12,11,9,7,5,4,4,4,4)), // Reger
    AUS_TIEFER_2(listOf(9,9,7,12,11,9,14,12,11,9,9,9,9, 12,12,11,12,14,7,11,9,7,7,7,7, 7,7,12,11,9,4,7,5,4,4,4,4,4,4,4,4)), // Reger
    ...
    EIN_FESTE_BURG_1(listOf(14,14,14,9,11,13,14,13,11,9,9,14,13,11,9,11,7,6,4,2,2)),
    EIN_FESTE_BURG_2(listOf(2,9,11,9,8,9,9,9,9, 2,9,11,13,14,14, 13,14,13,11,9,9)),
    EIN_FESTE_BURG_3(listOf(11,11,9,11,9,7,6,6, 14,13,11,9,11,9,7,6,4,4,2,2)),
    ...
    FUR_DEINEN_THRON_1(listOf(14,14,14,13,11,11,9,14,16,16,18,18,18,18, 18,18,18,18,16,16,18,19,18,18,16,16,16,16)), // Trauermusik
    FUR_DEINEN_THRON_2(listOf(14,16,16,18,16,16,14,11,13,13,14,14,14,14, 21,18,18,14,16,16,19,18,16,16,14,14,14,14)), // Trauermusik
    ...
    LOBE_DEN_HERREN_1(listOf(12,12,19,16,14,12,11,9,7,9,11,12,14,14,14,12,12,12,12,12,12)), // Reger
    LOBE_DEN_HERREN_2(listOf(19,19,19,21,21,21, 16,17,19,19,17,16,14,14,14,7,9,11,12,14,16,14,14,14,12,12,12,12,12,12)), // Reger
    ...
    MIT_FRIED_1(listOf(2,9,9,7,14,12,11,9,9, 12,11,9,11,11,9,9,9,9,9,9, 11,12,11,12,9,7,5,4,2,2)),
    MIT_FRIED_2(listOf(9,9,7,5,4,2,0,0,0,0, 9,5,12,9,7,5,7,9,9, 7,5,4,2,0,5,4,2,0,2,2,2,2,2,2,2,2)),
    ...
    NUN_KOMM_1(listOf(11,11,9,14,13,11,13,11,11,11,11, 11,13,14,16,14,16,18,14,14,14,14)), // Reger
    NUN_KOMM_2(listOf(14,16,18,16,14,16,14,13,11,11,11,11, 11,11,9,14,13,11,13,11,11,11,11)), // Reger
    ...
    WACHET_AUF_1(listOf(3,7,10,10,10,10,12,12,10,10,10,10, 10,15,10,15,17,19,17,15,14,12,10,10,10,10, 10,15,10,12,7,8,7,5,3,3)), // Reger
    WACHET_AUF_2(listOf(10,10,8,7,5,3,3,3,3, 10,10,8,7,5,3,3,3,3, 5,7,8,7,7)), // Reger
    WACHET_AUF_3(listOf(10,12,14,15,15, 15,17,19,17,15,15, 10,15,10,12,7,8,7,5,3,3,3,3)), // Reger
    ...
    WARUM_SOLLT(listOf(7,7,9,7,9,11,12,12,11,12,12,12,12, 14,16,12,12,12,12, 11,12,14,9,9,9,9, 14,14,12,11,9,9,9,7,7,7,7)),
    ...
    WER_WEISS_1(listOf(2,7,9,10,9,7,9,6,6,2,2, 5,5,3,2,7,7,6,7,7,7,7,7,7)), // Reger
    WER_WEISS_2(listOf(9,10,12,14,14,12,12,10,10, 14,12,10,9,7,9,10,9,7,7)), // Reger
    ...
    WIE_WOHL_1(listOf(12,9,10,12,17,14,12,12,10,9,9, 9,10,9,7,5,10,9,7,7,7,7,7,7)), // Reger
    WIE_WOHL_2(listOf(7,7,12,9,14,11,12,12,11,12,12, 7,7,12,9,14,11,12,12,11,12, 16,17,14,12,10,9,7,7,5,5,5,5)), // Reger

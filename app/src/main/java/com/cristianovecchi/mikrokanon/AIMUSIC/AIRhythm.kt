...
val Q = listOf(480); val Qstaccato = listOf(120,-360); val O = listOf(240); val Orest = listOf(-240); val Ostaccato = listOf(60, -180)
val Ohx4bow = listOf(120,120,120,60,-60)
val Ohx3bow = listOf(120,120,60,-60)
val Ohx2bow = listOf(120,60,-60)
...
enum class RhythmPatterns(val type: RhythmType, val title: String, val values: List<Int>,val metro: Pair<Int,Int> = METRO_4_4) {
    ...
    DOTTED1_4_4(RhythmType.PUNTATO,"Dotted1 4/4", listOf(360,120,360,120,360,120,360,120), METRO_4_4),
    ...
    DOTTED2_4_4(RhythmType.PUNTATO,"Dotted2 4/4", listOf(360,60,60,360,60,60,360,60,60,360,60,60), METRO_4_4),
    ...
    DOTTED3_4_4(RhythmType.PUNTATO,"Dotted3 4/4", listOf(300,60,60,60,300,60,60,60,300,60,60,60,300,60,60,60), METRO_4_4),
    ...
    MERENGUE_1(RhythmType.LATIN,"Merengue 1", listOf(720,240,480,480,240,240,240,240,480,480), Pair(4,4)),
    MERENGUE_2(RhythmType.LATIN,"Merengue 2", listOf(720,240,480,240,240, 480,480,240,240,240,240), Pair(4,4)),
    MERENGUE_3(RhythmType.LATIN,"Merengue 3", listOf(-240,480,240,480,480, 480,480,720,480,480,240,480,480,480,480,720,240), Pair(4,4)),
    MERENGUE_4(RhythmType.LATIN,"Merengue 4", listOf(-240,240,240,240,240,240,240,240, 240,240,240,240,480,-240,240), Pair(4,4)),
    MERENGUE_1BOW(RhythmType.LATIN,"Merengue 1♫♫", listOf(Ox3bow,Ostaccato,Ox2bow,Ox2bow,Ox4bow,Ox2bow,Ox2bow).flatten(), Pair(4,4)),
    MERENGUE_2BOW(RhythmType.LATIN,"Merengue 2♫♫", listOf(Ox3bow,Ostaccato,Ox2bow,Ox2bow,Ox2bow,Ox2bow, Ox4bow).flatten(), Pair(4,4)),
    MERENGUE_3BOW(RhythmType.LATIN,"Merengue 3♫♫", listOf(Orest,Ox2bow,Ostaccato,Ox2bow,Ox2bow, Ox2bow,Ox2bow, Ox3bow,Ox2bow,Ox2bow,Ostaccato,Ox2bow,Ox2bow,Ox2bow,Ox2bow, Ox3bow,Ostaccato).flatten(), Pair(4,4)),
    MERENGUE_4BOW(RhythmType.LATIN,"Merengue 4♫♫", listOf(Orest,Ox4bow,Ox4bow,listOf(240,240,240,480),Orest,Ostaccato).flatten(), Pair(4,4)),
    SAMBA_1(RhythmType.LATIN,"Samba 1", listOf(360,120,240,240,240,240,360,120), Pair(4,4)),
    SAMBA_2(RhythmType.LATIN,"Samba 2", listOf(-120,240,120,240,240,240,240,240,120,120), Pair(4,4)),
    SAMBA_3(RhythmType.LATIN,"Samba 3", listOf(-120,240,120,240,240,240,240,120,240,120), Pair(4,4)),
    SAMBA_4(RhythmType.LATIN,"Samba 4", listOf(-120,120,-120,120, 240,120,120, 240,120,120, 240,120,120), Pair(4,4)),
    RUMBA_1(RhythmType.LATIN,"Rumba 1", listOf(360,480,360,240,480), Pair(4,4)),
    RUMBA_2(RhythmType.LATIN,"Rumba 2", listOf(360,360,240, 240,120,240,120,240), Pair(4,4)),
    RUMBA_1BOW(RhythmType.LATIN,"Rumba 1♫♫", listOf(Ohx3bow,Ohx4bow,Ohx3bow,Ohx2bow,N4).flatten(), Pair(4,4)),
    RUMBA_2BOW(RhythmType.LATIN,"Rumba 2♫♫", listOf(Ohx3bow,Ohx3bow,Ohx2bow, Ohx2bow,listOf(60,-60),Ohx2bow,listOf(60,-60,120,120)).flatten(), Pair(4,4)),
    REGGAETON_1(RhythmType.LATIN,"Reggaeton 1", listOf(360,120,240,240,360,120,240,240), Pair(4,4)),
    REGGAETON_2(RhythmType.LATIN,"Reggaeton 2", listOf(360,120,-240,240,360,120,-240,240), Pair(4,4)),
    MONTUNO_1(RhythmType.LATIN,"Montuno 1", listOf(480,240,480,480,480,480,480,480,240), Pair(4,4)),
    MONTUNO_2(RhythmType.LATIN,"Montuno 2", listOf(480,120,120,240,120,120,480,480,480,480,480,240), Pair(4,4)),
    MONTUNO_3(RhythmType.LATIN,"Montuno 3", listOf(240,240,240,240,-240,480,240, -240,240,240,240,-240,480,240), Pair(4,4)),
    MONTUNO_4(RhythmType.LATIN,"Montuno 4", listOf(240,240,240,240,-240,480,240, -240,240,240,240,240,240,240,240, 240,240,240,240,-240,480,240, -240,480,240,-240,480,240), Pair(4,4)),
    MONTUNO_1BOW(RhythmType.LATIN,"Montuno 1♫♫", listOf(Ox2bow,Ostaccato,Ox2bow,Ox2bow,Ox2bow,Ox2bow,Ox2bow,Ox2bow,O).flatten(), Pair(4,4)),
    ...
    BOLERO_1(RhythmType.QUOTE,"Bolero♩♩",listOf(Qstaccato,N3,Qstaccato,N3,Qstaccato,Qstaccato, Qstaccato,N3,Qstaccato,N3,N3,N3).flatten(), Pair(3,2)),
    BOLERO_2(RhythmType.QUOTE,"Bolero♫",listOf(Ostaccato,N6h,Ostaccato,N6h,Ostaccato,Ostaccato, Ostaccato,N6h,Ostaccato,N6h,N6h,N6h).flatten(), Pair(3,4)),

...
object Ensembles {
    ...
    fun getEnsemble(nParts: Int, type: EnsembleType): List<EnsemblePart> {
        return when (type) {
            ...
            EnsembleType.TREMOLO_STRINGS -> getKeyboardInstrument(TREMOLO_STRINGS, nParts, RANGES.TREMOLO_STRINGS, IntRange(E1, C8))
            EnsembleType.PIZZICATO -> getKeyboardInstrument(PIZZICATO, nParts, RANGES.PIZZICATO, IntRange(E1, C8))
            EnsembleType.MUTED_BRASS -> getKeyboardInstrument(MUTED_TRUMPET, nParts, RANGES.MUTED_BRASS, IntRange(C2, C7))
            ...
            EnsembleType.ELECTRIC_PIANO_1 -> getKeyboardInstrument(ELECTRIC_PIANO_1, nParts, RANGES.ORGAN, IntRange(C2, C7))
            EnsembleType.ELECTRIC_PIANO_2-> getKeyboardInstrument(ELECTRIC_PIANO_2, nParts, RANGES.ORGAN, IntRange(C2, C7))
            EnsembleType.HAMMOND_ORGAN -> getKeyboardInstrument(HAMMOND_ORGAN, nParts,  RANGES.ORGAN, IntRange(C2, C7))
            EnsembleType.PERC_ORGAN ->  getKeyboardInstrument(PERC_ORGAN, nParts,  RANGES.ORGAN, IntRange(C2, C7))
            EnsembleType.BLUES_ORGAN ->  getKeyboardInstrument(BLUES_ORGAN, nParts, RANGES.ORGAN, IntRange(C2, C7))
            EnsembleType.CHURCH_ORGAN -> getKeyboardInstrument(CHURCH_ORGAN, nParts, RANGES.ORGAN, IntRange(C2, C7))
            EnsembleType.REED_ORGAN -> getKeyboardInstrument(REED_ORGAN, nParts, RANGES.MUTED_BRASS, IntRange(C2, C6))
            ...
            EnsembleType.SYN_BRASS_AND_LEAD -> getKeyboardInstrument(SYN_BRASS_AND_LEAD, nParts, RANGES.MUTED_BRASS, IntRange(C2, C6))
            EnsembleType.SYN_FANTASIA -> getKeyboardInstrument(SYN_FANTASIA, nParts, RANGES.MUTED_BRASS, IntRange(C2, C6))

...
object Ensembles {
    ...
    fun getEnsemble(nParts: Int, type: EnsembleType): List<EnsemblePart> {
        return when (type) {
            ...
            EnsembleType.ELECTRIC_PIANO_1 -> getKeyboardInstrument(ELECTRIC_PIANO_1, nParts, RANGES.NO_EXTREME_OCTAVES, IntRange(C2, C7))
            EnsembleType.ELECTRIC_PIANO_2-> getKeyboardInstrument(ELECTRIC_PIANO_2, nParts, RANGES.NO_EXTREME_OCTAVES, IntRange(C2, C7))
            EnsembleType.HAMMOND_ORGAN -> getKeyboardInstrument(HAMMOND_ORGAN, nParts,  RANGES.NO_EXTREME_OCTAVES, IntRange(C2, C7))
            EnsembleType.PERC_ORGAN ->  getKeyboardInstrument(PERC_ORGAN, nParts,  RANGES.NO_EXTREME_OCTAVES, IntRange(C2, C7))
            EnsembleType.BLUES_ORGAN ->  getKeyboardInstrument(BLUES_ORGAN, nParts, RANGES.NO_EXTREME_OCTAVES, IntRange(C2, C7))
            EnsembleType.CHURCH_ORGAN -> getKeyboardInstrument(CHURCH_ORGAN, nParts, RANGES.NO_EXTREME_OCTAVES, IntRange(C2, C7))
            EnsembleType.REED_ORGAN -> getKeyboardInstrument(REED_ORGAN, nParts, RANGES.OCTAVES_2334455, IntRange(C2, C6))
            ...
            EnsembleType.SYN_SAW_WAVE -> getKeyboardInstrument(SYN_SAW_WAVE, nParts, RANGES.SYN_SAW, IntRange(C3, C6))
            ...
            EnsembleType.SYN_BRASS_AND_LEAD -> getKeyboardInstrument(SYN_BRASS_AND_LEAD, nParts, RANGES.OCTAVES_2334455, IntRange(C2, C6))
            EnsembleType.SYN_FANTASIA -> getKeyboardInstrument(SYN_FANTASIA, nParts, RANGES.OCTAVES_2334455, IntRange(C2, C6))
            EnsembleType.WARM_PAD -> getKeyboardInstrument(WARM_PAD, nParts, RANGES.NO_LOWER_OCTAVE, IntRange(C2, C8))
            EnsembleType.POLYSYNTH -> getKeyboardInstrument(POLYSYNTH, nParts, RANGES.OCTAVES_2334455, IntRange(C2, C6))
            EnsembleType.SPACE_VOX -> getKeyboardInstrument(SPACE_VOX, nParts, RANGES.NO_EXTREME_OCTAVES, IntRange(C2, C7))
            ...
            EnsembleType.SWEEP_PAD -> getKeyboardInstrument(SWEEP_PAD, nParts, RANGES.OCTAVES_2334455, IntRange(C2, C6))

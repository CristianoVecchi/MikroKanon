...
sealed class Computation(open val icon: String = "") {
    ...
    data class Round(val counterpoints: List<Counterpoint>, val transpositions: List<Pair<Int, Int>>, val index: Int, override val icon: String = "round"): Computation()
    ...
    data class Resolutio(val counterpoints: List<Counterpoint>, val resolutioData: Triple<Set<Int>,String,Int>, val isWithNotes: Boolean, override val icon: String = "resolutio") : Computation()

...
sealed class Computation(open val icon: String = "") {
    ...
    data class FirstFromQuote(val counterpoint: Counterpoint, val firstSequence: ArrayList<Clip>, val genres: List<MelodyGenre>, val repeat: Boolean, override val icon: String = "quote"): Computation()
    ...
    data class FurtherFromQuote(val counterpoint: Counterpoint, val genres: List<MelodyGenre>, val repeat: Boolean, override val icon: String = "quote"): Computation()
